...
public class UserUnlocks { 
  ...
  private static final List<Unlock> UNLOCKS = Arrays.asList(
    ...
    new Unlock(Key.FT_COLOR, "Custom Colors", "Allows you to change your color in non-team games.", Type.FEATURE, 25000, false),
    new Unlock(Key.FT_SOUND, "Custom Sounds", "Allows you to upload and and use a custom sound effect. Plays when you come in 1st.", Type.FEATURE, 999999999, false)
  );
