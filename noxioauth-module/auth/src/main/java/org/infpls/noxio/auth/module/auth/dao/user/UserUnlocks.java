...
public class UserUnlocks { 
  ...
  private static final List<Unlock> UNLOCKS = Arrays.asList(
    ...
    new Unlock(Key.ALT_BOXDELTA, "Delta Box", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_BOXHIT, "Hitbox", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_BOXFOUR, "Four Box", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_BOXBLOOD, "Blood Box", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_BOXLOOT, "Loot Box", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    
    new Unlock(Key.ALT_CRATEVO, "Talking Crate", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_CRATEORANGE, "Orange Crate", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_CRATERAINBOW, "Rainbow Crate", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_CRATEGOLD, "Solid Gold Crate", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_CRATEDELTA, "Delta Crate", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_CRATEFIRE, "Spicy Crate", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_CRATEBLACK, "Blackflame Crate", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_CRATELOOT, "Loot Crate", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    ...
    new Unlock(Key.ALT_VOXDELTA, "Delta Crate", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_VOXBLACK, "Black Voxel", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_VOXLOOT, "Loot Vox", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    
    new Unlock(Key.ALT_QUADVO, "Talking Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_QUADRAINBOW, "Rainbow Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_QUADGOLD, "Solid Gold Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_QUADDELTA, "Delta Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_QUADFIRE, "Spicy Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_QUADLEGEND, "Undying Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_QUADRUNE, "Rune Quad", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    ...
    new Unlock(Key.ALT_BLOCKROUND, "Round Block", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_BLOCKWIN, "Block 95", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_BLOCKFIRE, "Spicy Block", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_BLOCKRO, "Roblock", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_BLOCKLOOT, "Loot Block", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    
    new Unlock(Key.ALT_CARGOVO, "Talking Cargo", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_CARGOPLUS, "Bad Cargo", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    ...
    new Unlock(Key.ALT_CARGOMINE, "Minecargo", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
    new Unlock(Key.ALT_CARGORETRO, "Retro Cargo", "Descriptions describe things.", Type.ALTERNATE, 100000, User.Type.FULL, false),
