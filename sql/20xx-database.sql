...
CREATE TABLE SETTINGS (
 ...
 GFXUPUI decimal(4,3) NOT NULL,
   ...
   GFXBLOOM bool NOT NULL DEFAULT false,
   GFXFRAMELIMIT int NOT NULL DEFAULT 60,
   GFXSHOWFPS bool NOT NULL DEFAULT false,
   /* --Controls-- */ CONENABLEGAMEPAD bool NOT NULL DEFAULT FALSE,
...
CREATE TABLE UNLOCKS (
 ...
 CHAR_CUBE bool NOT NULL DEFAULT FALSE,
 CHAR_POLY bool NOT NULL DEFAULT FALSE,
 CHAR_XOB bool NOT NULL DEFAULT FALSE,
 ...
 ALT_BOXDELTA bool NOT NULL DEFAULT FALSE,
 ...
 ALT_CRATEDELTA bool NOT NULL DEFAULT FALSE,
 ...
 ALT_VOXDELTA bool NOT NULL DEFAULT FALSE,
 ALT_VOXBLACK bool NOT NULL DEFAULT FALSE,
 ALT_VOXLOOT bool NOT NULL DEFAULT FALSE,
 ALT_QUADVO bool NOT NULL DEFAULT FALSE,
 ALT_QUADRAINBOW bool NOT NULL DEFAULT FALSE,
 ALT_QUADGOLD bool NOT NULL DEFAULT FALSE,
 ALT_QUADDELTA bool NOT NULL DEFAULT FALSE,
 ...
 ALT_BLOCKRAINBOW bool NOT NULL DEFAULT FALSE,
 ALT_BLOCKGOLD bool NOT NULL DEFAULT FALSE,
 ALT_BLOCKDELTA bool NOT NULL DEFAULT FALSE,
 ...
 ALT_CARGORAINBOW bool NOT NULL DEFAULT FALSE,
 ALT_CARGOGOLD bool NOT NULL DEFAULT FALSE,
 ALT_CARGODELTA bool NOT NULL DEFAULT FALSE,
 ...
 /* --Features-- */
 FT_LOBBY bool NOT NULL DEFAULT FALSE,
...
CREATE INDEX IDX_STATS_CREDITS ON STATS(LIFECREDITS);
CREATE INDEX IDX_STATS_UID ON STATS(UID);
CREATE INDEX IDX_SETTINGS_UID ON SETTINGS(UID);
CREATE INDEX IDX_UNLOCKS_UID ON UNLOCKS(UID);
