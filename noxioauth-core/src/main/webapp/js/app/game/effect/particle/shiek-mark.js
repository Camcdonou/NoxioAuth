...
function ParticleShiekMark(game, pos, vel, colorA, colorB) {
...
ParticleShiekMark.prototype.create = function() {
  ...
  var lineMat = this.game.display.getMaterial("character.shiek.effect.line");
  ...
  for(var i=0;i<17;i++) {
    ...
    this.pushPart({
      ...
      properties: {offset: util.vec3.scale(r, 1.45), vel: util.vec3.scale(r, -0.125), scale: 0.4, angle: axAng, color: util.vec4.copy3(colorA(), 0.35), tone: util.vec4.copy3(colorB(), 0)}
    });
  }
};

ParticleShiekMark.prototype.pushPart = Particle.prototype.pushPart;

ParticleShiekMark.prototype.step = Particle.prototype.step;

ParticleShiekMark.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleShiekMark.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleShiekMark.fxId = "particle";