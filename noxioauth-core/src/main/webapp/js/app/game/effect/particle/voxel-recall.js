...
function ParticleVoxelRecall(game, pos, vel, colorA, colorB) {
...
ParticleVoxelRecall.prototype.create = function() {
...
ParticleVoxelRecall.prototype.pushPart = Particle.prototype.pushPart;

ParticleVoxelRecall.prototype.step = Particle.prototype.step;

ParticleVoxelRecall.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleVoxelRecall.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleVoxelRecall.fxId = "particle";