...
/* Define Block Dash Dust Particle System Class */
function ParticleBlockDashRainbow(game, pos, vel, colorA, colorB) {
...
ParticleBlockDashRainbow.prototype.create = function() {
  var square = this.game.display.getModel("multi.square");
  var dashMat = this.game.display.getMaterial("character.block.effect.smokeRB");
...
ParticleBlockDashRainbow.prototype.pushPart = Particle.prototype.pushPart;

ParticleBlockDashRainbow.prototype.step = Particle.prototype.step;

ParticleBlockDashRainbow.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleBlockDashRainbow.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleBlockDashRainbow.fxId = "particle";