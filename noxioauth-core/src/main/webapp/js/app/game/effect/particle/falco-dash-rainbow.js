...
function ParticleFalcoDashRainbow(game, pos, vel) {
  Particle.call(this, game, pos, vel);
}

ParticleFalcoDashRainbow.prototype.create = function() {
  ...
  var flashMat = this.game.display.getMaterial("character.falco.effect.flashRB");
  var sparkMat = this.game.display.getMaterial("multi.hit.sparkRB");
  var blastMat = this.game.display.getMaterial("character.falco.effect.blastRB");
...
ParticleFalcoDashRainbow.prototype.pushPart = Particle.prototype.pushPart;

ParticleFalcoDashRainbow.prototype.step = Particle.prototype.step;

ParticleFalcoDashRainbow.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleFalcoDashRainbow.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleFalcoDashRainbow.fxId = "particle";