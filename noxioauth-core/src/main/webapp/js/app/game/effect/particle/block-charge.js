...
function ParticleBlockCharge(game, pos, vel, colorA, colorB) {
  this.colorA = colorA;
  this.colorB = colorB;
  Particle.call(this, game, pos, vel);
}

ParticleBlockCharge.prototype.create = function() {
  var square = this.game.display.getModel("multi.square");
  
  var shockwaveMat = this.game.display.getMaterial("character.block.effect.shockwave");
...
ParticleBlockCharge.prototype.pushPart = Particle.prototype.pushPart;

ParticleBlockCharge.prototype.step = Particle.prototype.step;

ParticleBlockCharge.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleBlockCharge.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleBlockCharge.fxId = "particle";