...
/* Define ParticlePuffSleepRainbow Particle System Class */
function ParticlePuffSleepRainbow(game, pos, vel) {
  Particle.call(this, game, pos, vel);
}

ParticlePuffSleepRainbow.prototype.create = function() {
  var square = this.game.display.getModel("multi.square");
  
  var sleepMat = this.game.display.getMaterial("character.puff.effect.sleepRB");
...
ParticlePuffSleepRainbow.prototype.pushPart = Particle.prototype.pushPart;

ParticlePuffSleepRainbow.prototype.step = Particle.prototype.step;

ParticlePuffSleepRainbow.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticlePuffSleepRainbow.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticlePuffSleepRainbow.fxId = "particle";