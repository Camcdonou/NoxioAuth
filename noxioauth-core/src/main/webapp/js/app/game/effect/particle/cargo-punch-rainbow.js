...
/* Define Cargo Punch Particle System Class */
function ParticleCargoPunchRainbow(game, pos, vel, colorA, colorB) {
...
ParticleCargoPunchRainbow.prototype.create = function() {
  ...
  var off = util.vec2.toVec3(util.vec2.scale(util.vec2.normalize(this.vel), PlayerCargo.PUNCH_HITBOX_OFFSET), 0);
...
ParticleCargoPunchRainbow.prototype.pushPart = Particle.prototype.pushPart;

ParticleCargoPunchRainbow.prototype.step = Particle.prototype.step;

ParticleCargoPunchRainbow.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleCargoPunchRainbow.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleCargoPunchRainbow.fxId = "particle";