...
function ParticleCubeDetonateBlip(game, pos, vel, colorA, colorB) {
...
ParticleCubeDetonateBlip.prototype.create = function() {
  ...
  var blip = {
    ...
    }, properties: {pos: this.pos, scale: 0.575, rotation: 0, color: colorA(), tone: colorB()}
  };
...
ParticleCubeDetonateBlip.prototype.pushPart = Particle.prototype.pushPart;

ParticleCubeDetonateBlip.prototype.step = Particle.prototype.step;

ParticleCubeDetonateBlip.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleCubeDetonateBlip.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleCubeDetonateBlip.fxId = "particle";