...
ParticleBloodSplat.prototype.create = function() {
  ...
  var splashMat = this.game.display.getMaterial("character.generic.effect.bloodsplash");
  var dropMat = this.game.display.getMaterial("character.generic.effect.blooddrop");
