...
function ParticleCargoChargeRainbow(game, pos, vel, colorA, colorB) {
...
ParticleCargoChargeRainbow.prototype.create = function() {
  var square = this.game.display.getModel("multi.square");
  var part2x = this.game.display.getModel("multi.fx.part2x");
  
  var shockwaveMat = this.game.display.getMaterial("character.cargo.effect.shockwaveRB");
  var rayMat = this.game.display.getMaterial("character.cargo.effect.rayRB");
...
ParticleCargoChargeRainbow.prototype.pushPart = Particle.prototype.pushPart;

ParticleCargoChargeRainbow.prototype.step = Particle.prototype.step;

ParticleCargoChargeRainbow.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleCargoChargeRainbow.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleCargoChargeRainbow.fxId = "particle";