...
function ParticleShatterSmall(game, pos, vel, colorA, colorB) {
...
ParticleShatterSmall.prototype.create = function() {
  ...
  var genFragSm = function(pos, vel) {
    ...
    return {
      ...
      properties: {pos: pos, vel: cmbvel, avel: angvel, angle: util.vec3.create(), scale: .85, color3: true}
    };
  };
  ...
  var boff = .125; // Offset to middle
  var bs = .85; // Size of md fragment
...
ParticleShatterSmall.prototype.pushPart = Particle.prototype.pushPart;

ParticleShatterSmall.prototype.step = Particle.prototype.step;

ParticleShatterSmall.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleShatterSmall.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleShatterSmall.fxId = "particle";