...
ParticleDashRainbow.prototype.create = function() {
  ...
  var shockwaveMat = this.game.display.getMaterial("character.box.effect.shockwaveRB");
  var speedLineMat = this.game.display.getMaterial("character.box.effect.speedlineRB");
