...
function ParticleMarthReadyRainbow(game, pos, vel) {
  Particle.call(this, game, pos, vel);
}

ParticleMarthReadyRainbow.prototype.create = function() {
  var square = this.game.display.getModel("multi.square");
  
  var shockwaveMat = this.game.display.getMaterial("character.marth.effect.shockwaveGroundRB");
...
ParticleMarthReadyRainbow.prototype.pushPart = Particle.prototype.pushPart;

ParticleMarthReadyRainbow.prototype.step = Particle.prototype.step;

ParticleMarthReadyRainbow.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleMarthReadyRainbow.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleMarthReadyRainbow.fxId = "particle";