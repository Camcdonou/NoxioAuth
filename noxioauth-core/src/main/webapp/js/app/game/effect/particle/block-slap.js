...
function ParticleBlockSlap(game, pos, vel, colorA, colorB) {
...
ParticleBlockSlap.prototype.create = function() {
  var square = this.game.display.getModel("multi.square");
  var part = this.game.display.getModel("multi.fx.part2x");
  var waveMat = this.game.display.getMaterial("character.block.effect.hitwave");
  var hitMat = this.game.display.getMaterial("character.block.effect.hit");
  var lineMat = this.game.display.getMaterial("character.block.effect.line");
...
ParticleBlockSlap.prototype.pushPart = Particle.prototype.pushPart;

ParticleBlockSlap.prototype.step = Particle.prototype.step;

ParticleBlockSlap.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleBlockSlap.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleBlockSlap.fxId = "particle";