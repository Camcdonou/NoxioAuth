...
function ParticleCrateDash(game, pos, vel, colorA, colorB) {
...
ParticleCrateDash.prototype.create = function() {
  ...
  var flashMat = this.game.display.getMaterial("character.crate.effect.flash");
  var sparkMat = this.game.display.getMaterial("multi.hit.spark");
  var blastMat = this.game.display.getMaterial("character.crate.effect.blast");
...
ParticleCrateDash.prototype.pushPart = Particle.prototype.pushPart;

ParticleCrateDash.prototype.step = Particle.prototype.step;

ParticleCrateDash.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleCrateDash.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleCrateDash.fxId = "particle";