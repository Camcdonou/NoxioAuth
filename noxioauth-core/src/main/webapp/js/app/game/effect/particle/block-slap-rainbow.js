...
/* Define Block Slap Hit Particle System Class */
function ParticleBlockSlapRainbow(game, pos, vel, colorA, colorB) {
...
ParticleBlockSlapRainbow.prototype.create = function() {
  var square = this.game.display.getModel("multi.square");
  var part = this.game.display.getModel("multi.fx.part2x");
  var waveMat = this.game.display.getMaterial("character.block.effect.hitwaveRB");
  var hitMat = this.game.display.getMaterial("character.block.effect.hitRB");
  var lineMat = this.game.display.getMaterial("character.block.effect.lineRB");
...
ParticleBlockSlapRainbow.prototype.pushPart = Particle.prototype.pushPart;

ParticleBlockSlapRainbow.prototype.step = Particle.prototype.step;

ParticleBlockSlapRainbow.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleBlockSlapRainbow.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleBlockSlapRainbow.fxId = "particle";