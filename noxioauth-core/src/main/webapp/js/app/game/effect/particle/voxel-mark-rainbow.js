...
/* Define Voxel Mark Rainbow Particle System Class */
function ParticleVoxelMarkRainbow(game, pos, vel) {
  Particle.call(this, game, pos, vel);
}

ParticleVoxelMarkRainbow.prototype.create = function() {
  ...
  var lineMat = this.game.display.getMaterial("character.voxel.effect.lineRB");
...
ParticleVoxelMarkRainbow.prototype.pushPart = Particle.prototype.pushPart;

ParticleVoxelMarkRainbow.prototype.step = Particle.prototype.step;

ParticleVoxelMarkRainbow.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleVoxelMarkRainbow.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleVoxelMarkRainbow.fxId = "particle";