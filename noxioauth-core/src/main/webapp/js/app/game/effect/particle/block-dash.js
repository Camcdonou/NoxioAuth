...
function ParticleBlockDash(game, pos, vel, colorA, colorB) {
...
ParticleBlockDash.prototype.create = function() {
  var square = this.game.display.getModel("multi.square");
  var dashMat = this.game.display.getMaterial("character.block.effect.smoke");
...
ParticleBlockDash.prototype.pushPart = Particle.prototype.pushPart;

ParticleBlockDash.prototype.step = Particle.prototype.step;

ParticleBlockDash.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleBlockDash.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleBlockDash.fxId = "particle";