...
function ParticleQuadRiposteRainbow(game, pos, vel) {
  Particle.call(this, game, pos, vel);
}

ParticleQuadRiposteRainbow.prototype.create = function() {
  var square = this.game.display.getModel("multi.square");
  var sheetVert = this.game.display.getModel("multi.sheetVert");
  
  var shockwaveMat = this.game.display.getMaterial("character.quad.effect.shockwaveRB");
  var riposteMat = this.game.display.getMaterial("character.quad.effect.riposteRB");
...
ParticleQuadRiposteRainbow.prototype.pushPart = Particle.prototype.pushPart;

ParticleQuadRiposteRainbow.prototype.step = Particle.prototype.step;

ParticleQuadRiposteRainbow.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleQuadRiposteRainbow.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleQuadRiposteRainbow.fxId = "particle";