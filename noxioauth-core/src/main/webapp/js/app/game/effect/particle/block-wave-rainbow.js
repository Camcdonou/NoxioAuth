...
function ParticleBlockWaveRainbow(game, pos, vel) {
  Particle.call(this, game, pos, vel);
}

ParticleBlockWaveRainbow.prototype.create = function() {
  var square = this.game.display.getModel("multi.square");
  
  var waveMat = this.game.display.getMaterial("character.block.effect.restwaveRB");
...
ParticleBlockWaveRainbow.prototype.pushPart = Particle.prototype.pushPart;

ParticleBlockWaveRainbow.prototype.step = Particle.prototype.step;

ParticleBlockWaveRainbow.prototype.getDraw = function(geometry, decals, lights, bounds) {
...
ParticleBlockWaveRainbow.prototype.active = Particle.prototype.active;

/* Used by EffectDefinition.js */
ParticleBlockWaveRainbow.fxId = "particle";