...
BallObject.prototype.stun = function() {
  
};

BallObject.prototype.stunGeneric = PlayerObject.prototype.stunGeneric;
BallObject.prototype.stunSlash = PlayerObject.prototype.stunSlash;
BallObject.prototype.stunElectric = PlayerObject.prototype.stunElectric;
BallObject.prototype.stunFire = PlayerObject.prototype.stunFire;
BallObject.prototype.criticalHit = PlayerObject.prototype.criticalHit;

BallObject.prototype.explode = function() { };
BallObject.prototype.fall = function() { };

BallObject.prototype.setPos = GameObject.prototype.setPos;
BallObject.prototype.setVel = GameObject.prototype.setVel;
BallObject.prototype.setHeight = GameObject.prototype.setHeight;

BallObject.prototype.getColor = function() {
...
BallObject.prototype.destroy = function() {
  for(var i=0;i<this.effects.length;i++) {
    this.effects[i].destroy();
  }
};

BallObject.prototype.type = function() { return "bal"; };