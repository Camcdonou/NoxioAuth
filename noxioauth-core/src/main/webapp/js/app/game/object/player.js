...
function PlayerObject(game, oid, pos, vel) {
  ...
  this.blipEffect = new Effect([ /* @FIXME Sound breaking format... */
    ...
    {type: "sound", class: this.game.sound, func: this.game.sound.getSound, params: ["prank/blip.wav"], update: function(snd){}, attachment: true, delay: 0, length: 33},
  ...
  this.dashEffect = new Effect([ /* @FIXME Sound breaking format... */
    {type: "sound", class: this.game.sound, func: this.game.sound.getSound, params: ["prank/ata.wav"], update: function(snd){}, attachment: true, delay: 0, length: 33},
  ...
  this.tauntEffect = new Effect([ /* @FIXME Sound breaking format... */
    {type: "sound", class: this.game.sound, func: this.game.sound.getSound, params: ["prank/cumown.wav"], update: function(snd){}, attachment: true, delay: 0, length: 33}
  ]);
  
  this.stunEffect = new Effect([ /* @FIXME Sound breaking format... */
    {type: "sound", class: this.game.sound, func: this.game.sound.getSound, params: ["prank/uheh.wav"], update: function(snd){}, attachment: true, delay: 0, length: 33},
  ...
  this.deathEffect = new Effect([ /* @FIXME Sound breaking format... */
    {type: "sound", class: this.game.sound, func: this.game.sound.getSound, params: ["prank/oowaa.wav"], update: function(snd){}, attachment: true, delay: 0, length: 99}
  ]);
};
