...
RespawnUI.prototype.hide = function() {
  this.hidden = true;
};
  ...
  this.texts = [
    {
      text: TEXT_MESSAGE,
      color: [1.0, 1.0, 1.0],
      pos: {x: 50.0-(txtLength/2), y: 30.0},
      size: FONT_SIZE
    }
  ];
};

RespawnUI.prototype.getDraw = function(blocks, text, mouse, window) {
