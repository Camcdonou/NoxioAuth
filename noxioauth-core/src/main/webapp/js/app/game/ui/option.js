...
function OptionUI(game, ui, name) {
  GenericUI.call(this, game, ui, name);
}

OptionUI.prototype.setVisible = GenericUI.prototype.setVisible;
OptionUI.prototype.show = GenericUI.prototype.show;
OptionUI.prototype.hide = GenericUI.prototype.hide;
OptionUI.prototype.refresh = GenericUI.prototype.refresh;

OptionUI.prototype.generate = function() {
  var parent = this;
  ...
  h += s;
  var TEAM        = "Change Team";
  var TEAM_LENGTH = util.font.textLength(TEAM, fontName, s);
  o = (w*0.5)-(TEAM_LENGTH*0.5);
  
  menuContainer.add({
    neutral: {
      block: [new GenericUIBlock(util.vec2.make(0,h), util.vec2.make(w,s), clear, colorMat)],
      text:  [new GenericUIText(util.vec2.make(o,h+v), s, swhite, fontName, fontMat, TEAM)]
    },
    hover: {
      block: [new GenericUIBlock(util.vec2.make(0,h), util.vec2.make(w,s), swhite, colorMat)],
...
OptionUI.prototype.pointInElement = GenericUI.prototype.pointInElement;

OptionUI.prototype.step = GenericUI.prototype.step;
OptionUI.prototype.play = GenericUI.prototype.play;
OptionUI.prototype.getDraw = GenericUI.prototype.getDraw;

OptionUI.prototype.clear = GenericUI.prototype.clear;
OptionUI.prototype.destroy = GenericUI.prototype.destroy;