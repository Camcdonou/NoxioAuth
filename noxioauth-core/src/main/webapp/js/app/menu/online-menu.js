    ...
    server: {
      ...
      updateServerInfo: function(ind, info, data) {
        ...
        if(data === undefined) { //Server Offline
          ...
          elm.innerHTML = data.name + " | " + data.location  + "<svg class='ico-serv' viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg' version='1.1'><circle cx='100' cy='100' r='85' fill='none' stroke='currentColor' stroke-width='30' /></svg>";
        }
      },
